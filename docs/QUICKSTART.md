...
3. Run `./scripts/table_stats_health.sh` for a quick health summary derived from the table stats.
...
4. Table stats health check (7.5 minutes). Command: `./scripts/table_stats_health.sh`.
